...
base_urls = ['https://www.emaotai.cn/browse/category-60.htm?flavortype=&pageindex=' +
...
def get_product_info(url):
    ...
    product_info = (data_date, title, product_id, brand,
                    price, view_count, sell_count, store_count)
    return product_info
...
with codecs.open('emaotai.csv', 'a', encoding='utf_8_sig') as f:
